.globl main
.data
  enterprompt: .word enterprompt_data
  factorialmsg: .word factorial_data
  value: .word value_data

  enterprompt_data: .asciiz "Enter a number between 1 and 10: "
  factorial_data: .asciiz "The value of factorial("
  value_data: .asciiz ") is "
...
main:
  ...
  la      $t0, enterprompt    # load address of enterprompt into $t0
  ...
  la      $t1, factorialmsg      # load msgres1 address into $t1
  ...
  la      $t2, value      #load msgres2 address into $t1
