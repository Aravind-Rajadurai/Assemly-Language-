################################################################################
# Name:    <Aravind Rajadurai>
# Class:   CS2318-254 (Assembly Language, Spring 2020)
...
####################(4)####################
					lw $t0, 0($a0)		#$t0 holds value at $a0
					lw $v1, 0($a1)		#$v1 holds value at $a1
					sw $v1, 0($a0)		#$v1 stored into $a0
					sw $t0, 0($a1)		#$t0 stored into $a1
